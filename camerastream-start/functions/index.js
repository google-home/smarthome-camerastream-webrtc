...
var allowList = ['https://www.gstatic.com']; //TODO Add Hosting URL.
...
app.onSync((body) => {
  return {
    ...
    payload: {
      ...
      devices: [{
        id: 'camera',
        type: '', //TODO: Add device type. 
        traits: [
          // TODO: Add device traits. 
        ],
        name: {
...
app.onExecute(async (body,headers) => {
  ...
  var result = {
    ...
    states: {
      ...
      cameraStreamSignalingUrl:'/signaling?token='+array[1], // TODO: Add Firebase 'signaling' function URL
